...
const Create: React.FunctionComponent<Props> = (props) => {
  ...
  const onSubmit = async (
    ...
    try {
      ...
      await makePayment({
        amount: price,
        paymentToken: {...paymentToken, address: tokens[data.network][paymentToken.id]},
      });
        ...
        {({setFieldValue, values}: any) => {
          ...
          return (
            <>
              ...
              <Form noValidate className="w-full z-10 flex justify-center" autoComplete="off">
                <Card className="w-3/4 z-10 grid grid-cols-2 gap-4">
